...
#define RCC_PROBE_PORT                RCC_APB2Periph_GPIOD
#define PROBE_BIT                     3
#define PROBE_MASK                    (1<<PROBE_BIT)
...
#define SPINDLE_PWM_RANGE         (SPINDLE_PWM_MAX_VALUE-SPINDLE_PWM_MIN_VALUE)
  ...
  //	2  Z_STEP_BIT									DVP use
  //	3  A_STEP_BIT									PROBE
  //	4  X_DIRECTION_BIT								unconnected
  //	5  Y_DIRECTION_BIT								CONTROL_RESET_BIT                  
  //	6  Z_DIRECTION_BIT								DVP use                         
  //	7  A_DIRECTION_BIT								CONTROL_CYCLE_START_BIT
  //	8  B_STEP_BIT				SPINDLE_PWM_BIT	    CONTROL_SAFETY_DOOR_BIT
  //	9  B_DIRECTION_BIT				                CONTROL_FEED_HOLD_BIT
  //	10 unconnected		                            C_LIMIT_BIT
  //	11 COOLANT_FLOOD_BIT							B_LIMIT_BIT
  //	12 COOLANT_MIST_BIT								X_LIMIT_BIT
  //	13 C_STEP_BIT			                        Y_LIMIT_BIT
  //	14 C_DIRECTION_BIT		                        Z_LIMIT_BIT

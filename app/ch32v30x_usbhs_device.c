...
EP0_Databuf[USBHS_UEP0_SIZE]; /* 端点0数据收发缓冲区 */
__attribute__ ((aligned(4))) UINT8
EP1_Rx_Databuf[USBHS_MAX_PACK_SIZE]; /* 端点1数据接收缓冲区 */
__attribute__ ((aligned(4))) UINT8
EP1_Tx_Databuf[USBHS_MAX_PACK_SIZE]; /* 端点1数据发送缓冲区 */
__attribute__ ((aligned(4))) UINT8
EP2_Rx_Databuf[USBHS_MAX_PACK_SIZE]; /* 端点2数据接收缓冲区 */
__attribute__ ((aligned(4))) UINT8
EP2_Tx_Databuf[USBHS_MAX_PACK_SIZE]; /* 端点2数据发送缓冲区 */
...
volatile UINT16 USBHS_Endp1_Up_Flag =
  0x00; /* USB2.0高速设备端点1数据上传状态: 0:空闲; 1:正在上传; */
volatile UINT8 USBHS_Endp1_Down_Flag =
  0x00; /* USB2.0高速设备端点1下传成功标志 */
...
volatile UINT16 USBHS_Endp2_Up_Flag =
  0x00; /* USB2.0高速设备端点2数据上传状态: 0:空闲; 1:正在上传; */
volatile UINT16 USBHS_Endp2_Up_LoadPtr =
  0x00; /* USB2.0高速设备端点2数据上传装载偏移 */
volatile UINT8 USBHS_Endp2_Down_Flag =
  0x00; /* USB2.0高速设备端点2下传成功标志 */

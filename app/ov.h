...
//PC13-RESET  PC3-PWDN
#define OV_RESET_SET   {GPIOC->BSHR = GPIO_Pin_2;}
#define OV_RESET_CLR   {GPIOC->BCR = GPIO_Pin_2;}
...
#define IIC_SCL_IN  {GPIOC->CFGLR&=0XFFFFFF0F;GPIOC->CFGLR|=8<<4;}
#define IIC_SCL_OUT {GPIOC->CFGLR&=0XFFFFFF0F;GPIOC->CFGLR|=3<<4;}
#define IIC_SDA_IN  {GPIOC->CFGLR&=0XFFFFFFF0;GPIOC->CFGLR|=8<<0;}
#define IIC_SDA_OUT {GPIOC->CFGLR&=0XFFFFFFF0;GPIOC->CFGLR|=3<<0;}

#define IIC_SDA_SET   {GPIOC->BSHR = GPIO_Pin_0;}
#define IIC_SDA_CLR   {GPIOC->BCR = GPIO_Pin_0;}
#define IIC_SCL_SET   {GPIOC->BSHR = GPIO_Pin_1;}
#define IIC_SCL_CLR   {GPIOC->BCR = GPIO_Pin_1;}

//SDA In
#define SDA_IN_R      (GPIOC->INDR & GPIO_Pin_0)
